...
<%@ Register Src="~/Catalogs/Epic/EpicMonth.ascx" TagPrefix="uc1" TagName="EpicMonth" %>
        ...
        <Columns>
            <asp:TemplateField HeaderText="January" SortExpression="January">
                ...
                <ItemTemplate>
                    ...
                    <uc1:EpicMonth runat="server" id="ctrEpicMonth01" />
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="February" SortExpression="February">
                ...
                <ItemTemplate>
                    ...
                    <uc1:EpicMonth runat="server" id="ctrEpicMonth02" />
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" Width="50px" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="March" SortExpression="March">
                ...
                <ItemTemplate>
                    ...
                    <uc1:EpicMonth runat="server" id="ctrEpicMonth03" />
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" Width="50px" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="April" SortExpression="April">
                ...
                <ItemTemplate>
                    ...
                    <uc1:EpicMonth runat="server" id="ctrEpicMonth04" />
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="May" SortExpression="May">
                ...
                <ItemTemplate>
                    ...
                    <uc1:EpicMonth runat="server" id="ctrEpicMonth05" />
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="June" SortExpression="June">
                ...
                <ItemTemplate>
                    ...
                    <uc1:EpicMonth runat="server" id="ctrEpicMonth06" />
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="July" SortExpression="July">
                ...
                <ItemTemplate>
                    ...
                    <uc1:EpicMonth runat="server" id="ctrEpicMonth07" />
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" Width="50px" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="August" SortExpression="August">
                ...
                <ItemTemplate>
                    ...
                    <uc1:EpicMonth runat="server" id="ctrEpicMonth08" />
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" Width="50px" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="September" SortExpression="September">
                ...
                <ItemTemplate>
                    ...
                    <uc1:EpicMonth runat="server" id="ctrEpicMonth09" />
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" Width="50px" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="October" SortExpression="October">
                ...
                <ItemTemplate>
                    ...
                    <uc1:EpicMonth runat="server" id="ctrEpicMonth10" />
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" Width="50px" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="November" SortExpression="November">
                ...
                <ItemTemplate>
                    ...
                    <uc1:EpicMonth runat="server" id="ctrEpicMonth11" />
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" Width="50px" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="December" SortExpression="December">
                ...
                <ItemTemplate>
                    ...
                    <uc1:EpicMonth runat="server" id="ctrEpicMonth12" />
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" Width="50px" />
            </asp:TemplateField>
        </Columns>
