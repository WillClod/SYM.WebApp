        ...
        protected void grdEpicMonthList_DataBound(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow gvRow in grdEpicMonthList.Rows)
            {
                ...
                if (hdnPeriodTypeId01 != null)
                {
                    ...
                    _EpicMonth = (EpicMonth)gvRow.FindControl("ctrEpicMonth01");
                    _EpicMonth.vciCompId = vciCompId;
                    _EpicMonth.vciEpicId = vciEpicId;                    
                    _EpicMonth.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId01.Value);                    
                    _EpicMonth.vcbRefresh = true;
                }

                if (hdnPeriodTypeId02 != null)
                {
                    // Refresh user control.                    
                    _EpicMonth = (EpicMonth)gvRow.FindControl("ctrEpicMonth02");
                    _EpicMonth.vciCompId = vciCompId;
                    _EpicMonth.vciEpicId = vciEpicId;
                    _EpicMonth.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId02.Value);
                    _EpicMonth.vcbRefresh = true;
                }
                ...
                {
                    // Refresh user control.                    
                    _EpicMonth = (EpicMonth)gvRow.FindControl("ctrEpicMonth03");
                    _EpicMonth.vciCompId = vciCompId;
                    _EpicMonth.vciEpicId = vciEpicId;
                    _EpicMonth.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId03.Value);
                    _EpicMonth.vcbRefresh = true;
                }
                ...
                {
                    // Refresh user control.                    
                    _EpicMonth = (EpicMonth)gvRow.FindControl("ctrEpicMonth04");
                    _EpicMonth.vciCompId = vciCompId;
                    _EpicMonth.vciEpicId = vciEpicId;
                    _EpicMonth.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId04.Value);
                    _EpicMonth.vcbRefresh = true;
                }
                ...
                {
                    // Refresh user control.                    
                    _EpicMonth = (EpicMonth)gvRow.FindControl("ctrEpicMonth05");
                    _EpicMonth.vciCompId = vciCompId;
                    _EpicMonth.vciEpicId = vciEpicId;
                    _EpicMonth.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId05.Value);
                    _EpicMonth.vcbRefresh = true;
                }
                ...
                {
                    // Refresh user control.                    
                    _EpicMonth = (EpicMonth)gvRow.FindControl("ctrEpicMonth06");
                    _EpicMonth.vciCompId = vciCompId;
                    _EpicMonth.vciEpicId = vciEpicId;
                    _EpicMonth.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId06.Value);
                    _EpicMonth.vcbRefresh = true;
                }
                ...
                {
                    // Refresh user control.                    
                    _EpicMonth = (EpicMonth)gvRow.FindControl("ctrEpicMonth07");
                    _EpicMonth.vciCompId = vciCompId;
                    _EpicMonth.vciEpicId = vciEpicId;
                    _EpicMonth.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId07.Value);
                    _EpicMonth.vcbRefresh = true;
                }
                ...
                {
                    // Refresh user control.                    
                    _EpicMonth = (EpicMonth)gvRow.FindControl("ctrEpicMonth08");
                    _EpicMonth.vciCompId = vciCompId;
                    _EpicMonth.vciEpicId = vciEpicId;
                    _EpicMonth.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId08.Value);
                    _EpicMonth.vcbRefresh = true;
                }
                ...
                {
                    // Refresh user control.                    
                    _EpicMonth = (EpicMonth)gvRow.FindControl("ctrEpicMonth09");
                    _EpicMonth.vciCompId = vciCompId;
                    _EpicMonth.vciEpicId = vciEpicId;
                    _EpicMonth.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId09.Value);
                    _EpicMonth.vcbRefresh = true;
                }
                ...
                {
                    // Refresh user control.                    
                    _EpicMonth = (EpicMonth)gvRow.FindControl("ctrEpicMonth10");
                    _EpicMonth.vciCompId = vciCompId;
                    _EpicMonth.vciEpicId = vciEpicId;
                    _EpicMonth.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId10.Value);
                    _EpicMonth.vcbRefresh = true;
                }
                ...
                {
                    // Refresh user control.                    
                    _EpicMonth = (EpicMonth)gvRow.FindControl("ctrEpicMonth11");
                    _EpicMonth.vciCompId = vciCompId;
                    _EpicMonth.vciEpicId = vciEpicId;
                    _EpicMonth.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId11.Value);
                    _EpicMonth.vcbRefresh = true;
                }
                ...
                {
                    // Refresh user control.                    
                    _EpicMonth = (EpicMonth)gvRow.FindControl("ctrEpicMonth12");
                    _EpicMonth.vciCompId = vciCompId;
                    _EpicMonth.vciEpicId = vciEpicId;
                    _EpicMonth.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId12.Value);
                    _EpicMonth.vcbRefresh = true;
                }
