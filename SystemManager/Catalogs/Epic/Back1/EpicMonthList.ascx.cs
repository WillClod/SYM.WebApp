...
{
    public partial class EpicMonthList : System.Web.UI.UserControl
    {
        ...
        public bool vcbRefresh
        {
            ...
            set
            {
                ...
                // Refresh grid.                
                srcEpicMonthSel.SelectParameters["CompId"].DefaultValue = vciCompId.ToString();
                srcEpicMonthSel.SelectParameters["EpicId"].DefaultValue = vciEpicId.ToString();
                srcEpicMonthSel.SelectParameters["YearId"].DefaultValue = vciYearId.ToString();
        ...
        protected void grdEpicMonthList_DataBound(object sender, EventArgs e)
        {
            // Set Variables.
            ...
            foreach (GridViewRow gvRow in grdEpicMonthList.Rows)
            {
                // Get control cell.
                ...
                if (hdnPeriodTypeId01 != null)
                {
                    ...
                    _CalendarPeriod = (CalendarPeriod)gvRow.FindControl("ctrCalendarPeriod01");
                    _CalendarPeriod.vciCompId = vciCompId;
                    _CalendarPeriod.vciEpicId = vciEpicId;                    
                    _CalendarPeriod.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId01.Value);                    
                    _CalendarPeriod.vcbRefresh = true;
                }

                if (hdnPeriodTypeId02 != null)
                {
                    // Refresh user control.                    
                    _CalendarPeriod = (CalendarPeriod)gvRow.FindControl("ctrCalendarPeriod02");
                    _CalendarPeriod.vciCompId = vciCompId;
                    _CalendarPeriod.vciEpicId = vciEpicId;
                    _CalendarPeriod.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId02.Value);
                    _CalendarPeriod.vcbRefresh = true;
                }
                ...
                {
                    // Refresh user control.                    
                    _CalendarPeriod = (CalendarPeriod)gvRow.FindControl("ctrCalendarPeriod03");
                    _CalendarPeriod.vciCompId = vciCompId;
                    _CalendarPeriod.vciEpicId = vciEpicId;
                    _CalendarPeriod.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId03.Value);
                    _CalendarPeriod.vcbRefresh = true;
                }
                ...
                {
                    // Refresh user control.                    
                    _CalendarPeriod = (CalendarPeriod)gvRow.FindControl("ctrCalendarPeriod04");
                    _CalendarPeriod.vciCompId = vciCompId;
                    _CalendarPeriod.vciEpicId = vciEpicId;
                    _CalendarPeriod.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId04.Value);
                    _CalendarPeriod.vcbRefresh = true;
                }
                ...
                {
                    // Refresh user control.                    
                    _CalendarPeriod = (CalendarPeriod)gvRow.FindControl("ctrCalendarPeriod05");
                    _CalendarPeriod.vciCompId = vciCompId;
                    _CalendarPeriod.vciEpicId = vciEpicId;
                    _CalendarPeriod.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId05.Value);
                    _CalendarPeriod.vcbRefresh = true;
                }
                ...
                {
                    // Refresh user control.                    
                    _CalendarPeriod = (CalendarPeriod)gvRow.FindControl("ctrCalendarPeriod06");
                    _CalendarPeriod.vciCompId = vciCompId;
                    _CalendarPeriod.vciEpicId = vciEpicId;
                    _CalendarPeriod.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId06.Value);
                    _CalendarPeriod.vcbRefresh = true;
                }
                ...
                {
                    // Refresh user control.                    
                    _CalendarPeriod = (CalendarPeriod)gvRow.FindControl("ctrCalendarPeriod07");
                    _CalendarPeriod.vciCompId = vciCompId;
                    _CalendarPeriod.vciEpicId = vciEpicId;
                    _CalendarPeriod.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId07.Value);
                    _CalendarPeriod.vcbRefresh = true;
                }
                ...
                {
                    // Refresh user control.                    
                    _CalendarPeriod = (CalendarPeriod)gvRow.FindControl("ctrCalendarPeriod08");
                    _CalendarPeriod.vciCompId = vciCompId;
                    _CalendarPeriod.vciEpicId = vciEpicId;
                    _CalendarPeriod.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId08.Value);
                    _CalendarPeriod.vcbRefresh = true;
                }
                ...
                {
                    // Refresh user control.                    
                    _CalendarPeriod = (CalendarPeriod)gvRow.FindControl("ctrCalendarPeriod09");
                    _CalendarPeriod.vciCompId = vciCompId;
                    _CalendarPeriod.vciEpicId = vciEpicId;
                    _CalendarPeriod.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId09.Value);
                    _CalendarPeriod.vcbRefresh = true;
                }
                ...
                {
                    // Refresh user control.                    
                    _CalendarPeriod = (CalendarPeriod)gvRow.FindControl("ctrCalendarPeriod10");
                    _CalendarPeriod.vciCompId = vciCompId;
                    _CalendarPeriod.vciEpicId = vciEpicId;
                    _CalendarPeriod.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId10.Value);
                    _CalendarPeriod.vcbRefresh = true;
                }
                ...
                {
                    // Refresh user control.                    
                    _CalendarPeriod = (CalendarPeriod)gvRow.FindControl("ctrCalendarPeriod11");
                    _CalendarPeriod.vciCompId = vciCompId;
                    _CalendarPeriod.vciEpicId = vciEpicId;
                    _CalendarPeriod.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId11.Value);
                    _CalendarPeriod.vcbRefresh = true;
                }
                ...
                {
                    // Refresh user control.                    
                    _CalendarPeriod = (CalendarPeriod)gvRow.FindControl("ctrCalendarPeriod12");
                    _CalendarPeriod.vciCompId = vciCompId;
                    _CalendarPeriod.vciEpicId = vciEpicId;
                    _CalendarPeriod.vciPeriodTypeId = Convert.ToInt32(hdnPeriodTypeId12.Value);
                    _CalendarPeriod.vcbRefresh = true;
                }
